...
public class GermplasmQueryTest {
	...
	private final String[] itemPropertyIds =
			new String[] {"LOCATIONS", "GROUP ID", "GID_REF", "Tag All Column", "LOTS","AVAILABLE","PARENTAGE", "METHOD NAME",
					"STOCKID", "NAMES", "GID"};
	@Mock
	...
	public void setUp() throws Exception {
		...
		for (int i = 0; i < 20; i++) {
			...
			inventoryInfo.setScaleForGermplsm(GERMPLSM_SCALE);
			inventoryInfo.setTotalAvailableBalance(AVAILABLE_BALANCE);
