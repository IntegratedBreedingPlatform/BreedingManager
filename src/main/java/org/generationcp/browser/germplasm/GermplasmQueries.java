...
public class GermplasmQueries implements Serializable{
	...
	if (searchString.contains("%")) {
	    count = 500;
	    germplasmList = managerGermplasm.findGermplasmByName(searchString, 0, count,
		    FindGermplasmByNameModes.NORMAL, Operation.LIKE, null, null, databaseInstance);
	} else {
	    count = managerGermplasm.countGermplasmByName(searchString, FindGermplasmByNameModes.NORMAL,
		    Operation.EQUAL, null, null, databaseInstance);
	    germplasmList = managerGermplasm.findGermplasmByName(searchString, 0, count,
		    FindGermplasmByNameModes.NORMAL, Operation.EQUAL, null, null, databaseInstance);
	}
