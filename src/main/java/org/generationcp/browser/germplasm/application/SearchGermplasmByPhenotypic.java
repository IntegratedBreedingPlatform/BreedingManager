...
import org.generationcp.browser.tabs.SearchGermplasmByPhenotypicTab;
import org.generationcp.browser.tabs.WelcomeTab;
...
public class SearchGermplasmByPhenotypic extends Application{
	...
	public void init() {
		...
		//create blank root layouts for the other tabs, the content will be added as the tabs are selected
		//or as the buttons on the WelcomeTab are clicked
		final VerticalLayout rootLayoutForGermplasmBrowser = new VerticalLayout();
		final VerticalLayout rootLayoutForStudyBrowser = new VerticalLayout();
		final VerticalLayout rootLayoutForGermplasmByPhenoTab = new VerticalLayout();
		...
		//add listener triggered by selecting tabs, this listener will create the content for the tabs dynamically as needed
		tabSheet.addListener(new TabSheet.SelectedTabChangeListener()
		{
			public void selectedTabChange(SelectedTabChangeEvent event)
			{
				...
				final TabSheet source = event.getTabSheet();
