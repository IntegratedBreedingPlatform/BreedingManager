...
public final class GermplasmIndexContainer{
    ...
    public IndexedContainer getGermplasResultContainer(String choice, String searchValue, Database databaseInstance)
    ...
    private static void addGermplasResultContainer(Container container, int gid, String names, String method,
	    String location) {
	...
	for (GermplasmNamesAttributesModel q : query) {
	    addGermplasNamesAttributeContainer(container, q.getType(), q.getName(), q.getDate(), q.getLocation(),
		    q.getTypeDesc());
	}
	return container;
    }
    ...
    private static void addGermplasNamesAttributeContainer(Container container, String type, String name, String date,
	    String location, String typeDesc) {
	Object itemId = container.addItem();
	Item item = container.getItem(itemId);
