...
import org.generationcp.browser.germplasm.wrap.model.GermplasmNamesAttributesModel;
import org.generationcp.browser.germplasm.wrap.model.GermplasmSearchResultModel;
...
public class GermplasmQueries implements Serializable{
	...
	public ArrayList<GermplasmSearchResultModel> getGermplasmListResultByPrefName(String searchBy,String searchString,Database databaseInstance) throws QueryException {
		List<Germplasm> germplasmList;
		int count;
		
		if(searchString.contains("%")){
			count = 500;
			germplasmList = managerGermplasm.findGermplasmByName(searchString, 0, count, FindGermplasmByNameModes.NORMAL, Operation.LIKE, null, null,databaseInstance);
		}else{
			count = managerGermplasm.countGermplasmByName(searchString, FindGermplasmByNameModes.NORMAL, Operation.EQUAL, null, null,databaseInstance);
			germplasmList = managerGermplasm.findGermplasmByName(searchString, 0, count, FindGermplasmByNameModes.NORMAL, Operation.EQUAL, null, null,databaseInstance);
		}
