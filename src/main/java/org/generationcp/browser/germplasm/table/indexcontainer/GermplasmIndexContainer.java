...
public final class GermplasmIndexContainer {
	...
	public IndexedContainer getGermplasResultContainer(String choice, String searchValue,Database databaseInstance) throws QueryException {
		...
		if(choice.equals(GERMPLASM_SEARCH_BY_NAMES)){
			...
			addGermplasResultContainer(container,queryByGid.getGid(),queryByGid.getNames(),queryByGid.getMethod(),queryByGid.getLocation());
		}
	...
	private static void addGermplasResultContainer(Container container,
			int gid,String names,String method, String location ) {
	...
	private static void addGermplasNamesAttributeContainer(Container container,
			String type,String name,String date, String location,String typeDesc ) {
		Object itemId = container.addItem();
		Item item = container.getItem(itemId);
	...
	private static void addGermplasGenerationHistory(Container container,
			int gid,String prefname) {
		Object itemId = container.addItem();
		Item item = container.getItem(itemId);
		item.getItemProperty(GERMPLASM_GID).setValue(gid);
