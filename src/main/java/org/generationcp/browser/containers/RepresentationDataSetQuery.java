...
public class RepresentationDataSetQuery implements Query
{
	...
	public List<Item> loadItems(int start, int numOfRows)
	{
		...
		catch(QueryException ex)
		{
			...
			System.out.println("Error with getting ounitids for representation: " + representationId);
	...
	public int size()
	{
		...
		catch(QueryException ex)
		{
			...
			System.out.println("Error with getting number of ounitids for representation: " + representationId);
			System.out.println(ex);
			ex.printStackTrace();
			return 0;
		}
