package org.generationcp.browser.cross.study.commons.trait.filter.listeners;
...
public class CharacterTraitLimitsValueChangeListener implements ValueChangeListener {
	...
	private List<String> acceptedLimits;
	...
	public void valueChange(ValueChangeEvent event) 
	{
		...
		if(!fromValidation.isEmpty()){
			...
			MessageNotifier.showError(parentWindow, "Error with entered limits", buffer.toString().trim(), Notification.POSITION_CENTERED);
		}
	}
