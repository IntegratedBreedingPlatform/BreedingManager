...
@Configurable
public class SelectTraitsSection extends VerticalLayout implements
	...
	private static final Logger LOG = LoggerFactory.getLogger(SelectTraitsSection.class);
	...
	public SelectTraitsSection(List<Integer> environmentIds, Window parentWindow) {
		super();
	...
	private void initializeComponents() {
		...
		traitTreeTable.setHeight("200px");
		traitTreeTable.setWidth("100%");
		...
		traitSelectTable.setHeight("200px");
		traitSelectTable.setWidth("100%");
		...
		addComponent(traitTreeTable);
		addComponent(traitSelectTable);
