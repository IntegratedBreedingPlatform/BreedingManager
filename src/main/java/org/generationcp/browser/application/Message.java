...
public enum Message {
     ...
     ,SECOND_SECTION
     ,THIRD_SECTION
     ,GET_NUMERIC_VARIATES
     ,APPLY_AND_PROCEED_TO_NEXT_SECTION
     ,FIELD_IS_REQUIRED
     ,LIMITS
     ,NUMBER_OF_LOCATIONS
     ,NUMBER_OF_LINES
     ...
     ,CATEGORICAL_TRAITS_SECTION_TITLE
     ,DISTINCT_OBSERVED_VALUES
     ,CHARACTER_TRAIT_FILTER_TAB_TITLE
     ,CATEGORICAL_VARIATES
     ,CLASS
     ,INTRODUCTION
     ,QUERY_FOR_ADAPTED_GERMPLASM_INTRODUCTION_MESSAGE
     ,EXPORT_TO_EXCEL
     ...
     ,LOAD_ENVIRONMENTS_INCLUDING_PUBLIC
     ,LOAD_ENVIRONMENTS_EXCLUDING_PUBLIC
     ,LOAD_TRAITS_CONFIRM
     ,STUDIES
     ,PROGRAM_STUDIES
     ,PUBLIC_STUDIES
     ...
     ,WARNING
     ,H2H_NUM_OF_TRAITS_EXCEEDED
     
     ,INVALID_INPUT
     ,INVALID_BLANK_STUDY_FOLDER_NAME
     ,INVALID_LONG_STUDY_FOLDER_NAME
     ,EXISTING_STUDY_ERROR_MESSAGE
     ,PLEASE_SEE_ERROR_LOG
     ,ERROR_WITH_MODIFYING_STUDY_TREE
     ,MOVE_PUBLIC_LISTS_NOT_ALLOWED
     ,MOVE_YOUR_LISTS_TO_PUBLIC_FOLDERS_NOT_ALLOWED
