...
public class RepresentationDatasetComponent extends VerticalLayout{
    ...
    public RepresentationDatasetComponent(StudyDataManager dataManager, Integer representationId, String datasetTitle,
	    Integer studyId) {
	super();
	...
	RepresentationDatasetQueryFactory factory = new RepresentationDatasetQueryFactory(dataManager,
		representationId, columnIds);
