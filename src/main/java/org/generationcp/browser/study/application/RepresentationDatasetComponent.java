...
import org.generationcp.browser.containers.RepresentationDatasetQueryFactory;
...
public class RepresentationDatasetComponent extends VerticalLayout
{
	...
	public RepresentationDatasetComponent(StudyDataManager dataManager, Integer representationId, String datasetTitle, Integer studyId)
	{
		...
		catch(QueryException ex)
		{
			...
			System.out.println("Error with getting factors of representation: " + representationId);
		...
		{
			System.out.println("Error with getting variates of representation: " + representationId);
			System.out.println(ex);
			ex.printStackTrace();
		...
		exportCsvButton.addListener(new Button.ClickListener()
		{
			private static final long serialVersionUID = -2439636276210294435L;
