...
public class StudyTreePanel extends VerticalLayout{
	...
	private Tree createStudyTree(Database database)
	{
		...
		studyTree.addListener(new Tree.ExpandListener() {

			public void nodeExpand(ExpandEvent event) {
				addStudyNode(Integer.valueOf(event.getItemId().toString()));
			}

		});

		studyTree.addListener(new ItemClickEvent.ItemClickListener() {
	...
	private void addStudyNode(int parentStudyId)
	{
