...
public class StudyDetailComponent extends I18NGridLayout{
    ...
    public StudyDetailComponent(StudyDataManager studyDataManager, int StudyId, I18N i18n) throws QueryException {
        ...
        Study study = studyDataManager.getStudyByID(StudyId);
