...
public class AdditionalDetailsCrossNameComponent extends AbsoluteLayout 
    ...
    public void afterPropertiesSet() throws Exception {  
        ...
        specifyStartNumberCheckbox = new CheckBox("Specify a different starting sequence number:");
    ...
    private void layoutComponents() {
        ...
        addComponent(specifyStartNumberCheckbox, "top:125px;left:0px");
        addComponent(startNumberTextField, "top:125px;left:300px");
        
        addComponent(nextNameInSequenceLabel, "top:170px;left:0px");
        addComponent(generatedNameLabel, "top:170px;left:265px");
        addComponent(generateButton, "top:180px;left:0px");
    }
    ...
    public void generateNextNameButtonAction(){
        if (validateCrossNameFields()) {
            ...
            try {
                ...
                if (specifyStartNumberCheckbox.booleanValue()){
                	Integer startNumber = Integer.parseInt(startNumberTextField.getValue().toString());
    ...
    private boolean validateCrossNameFields(){
        ...
        } else if (!validateStartNumberField(true)){
        	return false;
        }
    ...
    private boolean validateGeneratedName(){
        ...
        // If Generate button not pressed after specifying start number   
        } 
