...
public class GermplasmListTreeTable extends TreeTable implements GermplasmListSource {
    ...
    public String getItemCaption(Object itemId){
        if(this.getItem(itemId) != null && this.getItem(itemId).getItemProperty(NAME_COL) != null && this.getItem(itemId).getItemProperty(NAME_COL).getValue() != null) {
            return (String) this.getItem(itemId).getItemProperty(NAME_COL).getValue();
        }
        return "";
    }
    ...
    public void setItemCaption(Object itemId, String caption){
        this.getItem(itemId).getItemProperty(NAME_COL).setValue(" " + caption);
    }
}
