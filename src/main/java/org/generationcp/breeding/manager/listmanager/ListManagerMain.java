...
public class ListManagerMain extends VerticalLayout implements
	...
	public void afterPropertiesSet() throws Exception {
        ...
        tabSheet.addTab(browseListsComponent, messageSource.getMessage(Message.SEARCH_LISTS));
        tabSheet.addTab(searchListsComponent, messageSource.getMessage(Message.SEARCH_GERMPLASM));
