...
public enum TemplateCrossingCondition {
    ...
    ,BREEDING_METHOD_ID("BREEDING METHOD ID")
    ,FEMALE_LIST_NAME("FEMALE LIST NAME")
    ,FEMALE_LIST_ID("FEMALE LIST ID")
    ,MALE_LIST_NAME("MALE LIST NAME")
    ,MALE_LIST_ID("MALE LIST ID");
