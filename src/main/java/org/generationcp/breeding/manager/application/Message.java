...
public enum Message{
    ...
    ,ADD_GERMPLASM_DETAILS
    ,SELECT_PEDIGREE_OPTIONS
    ,UPLOAD
    ,WELCOME_LABEL
    ...
    ,LISTDATA_PARENTAGE_HEADER
    ,LISTDATA_AVAIL_INV_HEADER
    ,LISTDATA_SEED_RES_HEADER
    ...
    ,ERROR_ACCESSING_PEDIGREE_STRING
    ...
    ,MAKE_CROSSES_OPTION_GROUP_ITEM_PLEASE_CHOOSE
    ...
    ,LEADING_ZEROS
    ,DIGITS
    ,SELECT_MATCHING_GERMPLASM_OR_ADD_NEW_ENTRY
    ...
    ,ADD_ENTRIES
    ,COPY_TO_NEW_LIST
    ,ADD_SELECTED_ENTRIES_TO_NEW_LIST
    ,RESERVE_INVENTORY
    ,RESERVATION_STATUS
    ,FILL_WITH_EMPTY
    ,FILL_WITH_PREF_NAME
    ...
    ,ERROR_ITEM_DOES_NOT_EXISTS
    ,ERROR_NO_SELECTION
    ,ERROR_HAS_CHILDREN
    ,LIST_AND_ENTRIES_SAVED_SUCCESS
    ,LIST_DATA_SAVED_SUCCESS
    ...
    //Export List
    ,EXPORT_FORMAT
    ,CHOOSE_AN_EXPORT_FORMAT
    ,EXPORT_LIST
    ,EXPORT_GERMPLASM_LIST
    ,EXPORT_WARNING_MESSAGE
    ,EXPORT_LIST_FOR_GENOTYPING_ORDER
    ...
    ,ERROR_UNABLE_TO_DELETE_LIST_NON_OWNER
    ...
    ,DIALOG_ADD_TO_FEMALE_LABEL
    ,DIALOG_ADD_TO_MALE_LABEL
    ,DIALOG_OPEN_FOR_REVIEW_LABEL
    
    ,COULD_NOT_MAKE_ANY_RESERVATION_ALL_SELECTED_LOTS_HAS_INSUFFICIENT_BALANCES
    ,AVAIL_INV
    ,SEED_RES, FOR_A_LIST
    ,AUTOMATICALLY_ACCEPT_SINGLE_MATCHES_WHENEVER_FOUND
    ,NO_SEARCH_RESULTS_UNCHECKED_PUBLIC_DATA
    ,CONFIRM_RESET_CROSSING_MANAGER_SETTINGS_TITLE
    
    //Generate StockID Dialog
    ,SPECIFY_STOCKID_PREFIX_LABEL
    ,DEFAULT_PREFIX_DESCRIPTION_LABEL
    ,NEXT_PREFIX_IN_SEQUENCE_LABEL
    ,EXAMPLE_STOCKID_LABEL
    ,GENERATE_STOCKID_HEADER
}
