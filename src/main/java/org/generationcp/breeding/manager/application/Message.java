...
public enum Message {
	...
	, SELECT_ALL, SELECT_EVEN_ENTRIES, SELECT_ODD_ENTRIES, INVENTORY_VIEW,LIST_EDITING_OPTIONS,CODING_AND_FIXING_OPTIONS,PREPARE_SEED, TOTAL_LOTS, INVENTORY, EDIT_VALUE, SAVE_CHANGES, UNSAVED_CHANGES, DISCARD_CHANGES, CANCEL_RESERVATIONS, SAVE_RESERVATIONS, RETURN_TO_LIST_VIEW, DELETE_LIST, ADD_ENTRIES, COPY_TO_LIST, ADD_SELECTED_ENTRIES_TO_NEW_LIST, RESERVE_INVENTORY, RESERVATION_STATUS, FILL_WITH_EMPTY, FILL_WITH_PREF_NAME, FILL_WITH_PREF_ID, FILL_WITH_ATTRIBUTE, FILL_WITH_ATTRIBUTE_WINDOW, FILL_WITH_LOCATION_NAME, FILL_WITH_BREEDING_METHOD_INFO, FILL_WITH_BREEDING_METHOD_NAME, FILL_WITH_BREEDING_METHOD_ID, FILL_WITH_BREEDING_METHOD_GROUP, FILL_WITH_BREEDING_METHOD_NUMBER, FILL_WITH_BREEDING_METHOD_ABBREVIATION, FILL_WITH_GERMPLASM_DATE, FILL_WITH_CROSS_FEMALE_INFORMATION, FILL_WITH_CROSS_FEMALE_GID, FILL_WITH_CROSS_FEMALE_PREFERRED_NAME, FILL_WITH_CROSS_MALE_INFORMATION, FILL_WITH_CROSS_MALE_GID, FILL_WITH_CROSS_MALE_PREFERRED_NAME, FILL_WITH_CROSS_EXPANSION
