...
public enum Message {
	...
	, SPECIFY_STOCKID_PREFIX_LABEL, DEFAULT_PREFIX_DESCRIPTION_LABEL, NEXT_PREFIX_IN_SEQUENCE_LABEL, EXAMPLE_STOCKID_LABEL, GENERATE_STOCKID_HEADER, CREATE_LABELS, ERROR_COULD_NOT_CREATE_LABELS, INVALID_PREFIX
}
