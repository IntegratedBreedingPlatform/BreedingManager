...
public enum Message {
	MAIN_WINDOW_CAPTION, BACK, NEXT, DONE, OK, SUCCESS, QUERY_EXCEPTION, UNKNOWN, CANCEL, DISPLAY, HERE
	...
	// Germplasm Import
	, OPEN_GERMPLASM_IMPORT_FILE, PEDIGREE_OPTIONS_LABEL, SAVE_GERMPLASM_LIST, SELECT_GERMPLASM_LIST_FILE, CHOOSE_IMPORT_FILE, SPECIFY_GERMPLASM_DETAILS, ADD_GERMPLASM_DETAILS, SELECT_PEDIGREE_OPTIONS, UPLOAD, WELCOME_LABEL, WELCOME_QUESTION_LABEL, WELCOME_TAB_LABEL
	...
	// Make Cross Screen
	, LABEL_FEMALE_PARENTS, LABEL_MALE_PARENTS, LABEL_FEMALE_PARENT, LABEL_MALE_PARENT, FEMALE, MALE, SELECT_FEMALE_LIST_BUTTON_LABEL, SELECT_MALE_LIST_BUTTON_LABEL, MAKE_CROSSES_OPTION_GROUP_ITEM_PLEASE_CHOOSE, MAKE_CROSSES_OPTION_GROUP_ITEM_ONE_LABEL, MAKE_CROSSES_OPTION_GROUP_ITEM_TWO_LABEL, MAKE_CROSSES_CHECKBOX_LABEL, MAKE_CROSSES_BUTTON_LABEL, LABEL_CROSS_MADE, ERROR_CROSS_MUST_BE_SELECTED, ERROR_IN_GETTING_CROSSING_NAME_TYPE, ERROR_MALE_AND_FEMALE_PARENTS_MUST_BE_EQUAL, ERROR_GERMPLASM_LIST_IMPORT_BOTH_ID_REQUIRED, ERROR_GERMPLASM_LIST_IMPORT_MALE_ID_REQUIRED, ERROR_GERMPLASM_LIST_IMPORT_FEMALE_ID_REQUIRED, INVALID_NURSERY_TEMPLATE_FILE, INVALID_CROSSING_TEMPLATE_FILE, NUMBER, REVIEW_CROSSES

	// Nursery Template Screens
	, I_WANT_TO_WRITE_NURSERY_TEMPLATE_FILES, NURSERY_TEMPLATE_TAB_LABEL, NURSERY_TEMPLATE_CAPTION_LABEL, SPECIFY_NURSERY_CONDITIONS_LABEL, CONDITION_HEADER, DESCRIPTION_HEADER, PROPERTY_HEADER, SCALE_HEADER, VALUE_HEADER, INVALID_SITE_ID, INVALID_BREEDER_ID, INVALID_METHOD_ID, PARENTAGE, CONFIRM_DIALOG_CAPTION_EXPORT_NURSERY_FILE, CONFIRM_DIALOG_MESSAGE_EXPORT_NURSERY_FILE, ADD_SPACE_BETWEEN_PREFIX_AND_CODE, SELECT_A_METHOD, CROSS_NAME, SEQUENCE_NUMBER_SHOULD_HAVE, LEADING_ZEROS, DIGITS, SELECT_MATCHING_GERMPLASM_OR_ADD_NEW_ENTRY, BY_CLICKING_ON_THE_DONE_BUTTON, START_NEW_IMPORT, CLICKING_ON_DONE_WOULD_MEAN_THE_LIST_LIST_ENTRIES_AND_GERMPLASM_RECORDS_WILL_BE_SAVED_IN_THE_DATABASE
	...
	, SUMMARY, CROSS_LIST_ENTRIES, EXPORT_CROSS_LIST, MGID, FGID, FEMALE_PARENT_LIST_DETAILS, MALE_PARENT_LIST_DETAILS, SAVED_AS, BREEDING_METHOD_APPLIED_TO_NEW_CROSSES
	...
	, SPECIFY_STOCKID_PREFIX_LABEL, DEFAULT_PREFIX_DESCRIPTION_LABEL, NEXT_PREFIX_IN_SEQUENCE_LABEL, EXAMPLE_STOCKID_LABEL, GENERATE_STOCKID_HEADER
}
