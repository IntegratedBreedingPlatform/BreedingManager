...
public enum Message {
	MAIN_WINDOW_CAPTION, BACK, NEXT, BACK_TO_NURSERY, BACK_TO_NURSERY_DESCRIPTION, DONE, OK, SUCCESS, QUERY_EXCEPTION, UNKNOWN, CANCEL,
	DISPLAY, HERE, PERIOD
	...
	// Error Messages
	, ERROR_INTERNAL, ERROR_PLEASE_CONTACT_ADMINISTRATOR, ERROR_MUST_BE_SPECIFIED, ERROR_WITH_CROSSES_RETRIEVAL,
	ERROR_WITH_REQUEST_PARAMETERS, ERROR_WRONG_GERMPLASM_LIST_ID, ERROR_WRONG_NURSERY_ID
	...
	, MARK_LINES_AS_FIXED, ERROR_MARK_LINES_AS_FIXED_NOTHING_SELECTED, PRESERVE_EXISTING_GROUP, INCLUDE_DESCENDANTS, SUCCESS_MARK_LINES_AS_FIXED, GROUPING_RESULTS_CAPTION, GENERATIVE_GERMPLASM_NOT_GROUPED

	, ASSIGN_CODES, ERROR_ASSIGN_CODES_NOTHING_SELECTED, ASSIGN_CODES_HEADER, CODING_LEVEL, ASSIGN_CODES_RESULTS_HEADER, APPLY_CODES,
	ASSIGN_CODES_EXAMPLE, ERROR_PREFIX_TOO_LONG, ERROR_YEAR_TOO_LONG, LEVEL1, LEVEL2, LEVEL3, PROGRAM_IDENTIFIER_LABEL,
	GERMPLASM_TYPE_LABEL, YEAR_LABEL, LOCATION_IDENTIFIER_LABEL, PREFIX_LABEL
